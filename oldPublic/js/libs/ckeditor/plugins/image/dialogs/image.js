      ...
      },
       {
        ...
        onClick: function() {
         ...
         (box || dlog).showIframe({
          title:"图片选择",
          width:500,
          url:document.getElementsByClassName("fake-img")[0].getAttribute("url"),
          data:{key:1},
          callback: function (data) {
           var urlObj = document.getElementById(txtUrlId);
           urlObj.value = data.image_src;
           //alert("2")
           var browseObj = $(".ImagePreviewBox img");
           browseObj.attr("src",data.image_src).css("display","inline-block");
